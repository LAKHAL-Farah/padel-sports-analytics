...
def scrape_player_profile(player_url):
    ...
    try:
        ...
        if h2_element:
            ...
            if name_text and name_text not in ["Back to Ranking", "FEMALE FIP RANKING", "Points breakdown by tournament", "TITLES AND FINALS"]:
        ...
        if player_name == "Unknown":
            ...
            if h1_element:
                ...
                if name_text and name_text not in ["Back to Ranking", "FEMALE FIP RANKING"]:
                    player_name = name_text
...
def scrape_ranking_page():
    """Scrape female ranking page and get all players with ranking and points"""
    ranking_url = "https://www.padelfip.com/ranking-female/"
...
def main():
    print("🏓 Scraping Padel FIP Player Data (Female Ranking)")
    print("=" * 60)
    ...
    if all_players:
        ...
        output_file = "padel_players_female_data.csv"
