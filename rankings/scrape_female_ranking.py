...
def scrape_female_ranking():
    """Scrape female ranking table from padelfip.com"""
...
def main():
    print("🏓 Scraping Padel FIP Female Ranking")
    print("=" * 60)
    
    players = scrape_female_ranking()
    
    if players:
        df = pd.DataFrame(players)
        
        output_file = "female_ranking.csv"
